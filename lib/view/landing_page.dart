            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    'Next-Gen Property\nInspection App',
                    style: GoogleFonts.poppins(fontSize: 32, fontWeight: FontWeight.bold, color: AppColors.primaryColor),
                  ),
                ),
                Padding(
                  ...
                  child: Text(
                    ...
                    style: GoogleFonts.poppins(fontSize: 24, color: AppColors.secondaryColor),
                  ),
                ),
                Spacer(flex: 2),
                Container(
